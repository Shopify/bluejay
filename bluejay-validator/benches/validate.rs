...
static CASES: &[QueryCase] = &[
    QueryCase { name: "simple", source: QUERY_SIMPLE },
    QueryCase { name: "fragments", source: QUERY_FRAGMENTS },
    QueryCase { name: "complex", source: QUERY_COMPLEX },
];
        ...
        group.bench_with_input(
            ...
            |b, doc| {
                b.iter(|| {
                    ...
                    let errors: Vec<_> =
                        BuiltinRulesValidator::validate(doc, &*SCHEMA_DEFINITION, &cache)
                            .collect();
