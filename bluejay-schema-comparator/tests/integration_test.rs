...
fn test_schema_compare() {
    ...
    let mut expected_messages = vec![
        ...
        "Default value `integer` was added to argument `arg` on field `CType.d`",
        "Default value `string` was added to directive argument `yolo.anotherArg`",
        "Default value for argument `arg` on field `WithArguments.b` was changed from `integer to `integer`",
        ...
        "Input field `AInput.a` default value changed from `string` to `integer`",
